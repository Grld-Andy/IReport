  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/90 backdrop-blur-md shadow-sm border-b border-lime-100"
          : "bg-transparent"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link to="/auth/login">
            <Button
              variant={"outline"}
              className="text-sm font-semibold text-gray-700 transition-colors px-3 py-1.5"
            >
              Sign in
            </Button>
          </Link>
          <Link to="register">
            <Button className="text-sm font-bold bg-lime-400 hover:bg-lime-500 text-gray-900 px-5 py-2 transition-all hover:shadow-md hover:shadow-lime-200 active:scale-95">
              Get started
            </Button>
          </Link>
        </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <div className="inline-flex items-center gap-2 bg-lime-50 border border-lime-200 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-xs font-semibold text-lime-700 uppercase tracking-widest">
        ...
        <div className="hidden lg:block relative">
          <div className="relative bg-white rounded-3xl border border-gray-100 shadow-2xl shadow-gray-200/80 overflow-hidden p-6">
            ...
            <div className="space-y-2">
              {[
                ...
                {
                  id: "#1039",
                  title: "Forklift battery failure",
                  sev: "Low",
                  status: "Resolved",
                  ago: "1h ago",
                  sevColor: "bg-gray-100 text-gray-600",
                },
              ].map((row) => (
                <div
                  key={row.id}
                ...
                >
                  ...
                  <span
                    className={`text-xs font-bold rounded-full px-2 py-0.5 ${row.sevColor}`}
                  >
                    {row.sev}
                  </span>
                </div>
          ...
          <div className="absolute -bottom-4 -right-4 bg-white border border-gray-100 shadow-lg rounded-2xl px-4 py-3">
            ...
            <p className="text-xl font-black text-gray-900">
              12 <span className="text-lime-500 text-sm font-bold">active</span>
            </p>
          </div>
        </div>
      </div>
...
function IndustriesSection() {
  return (
    <section
      id="industries"
      className="py-16 bg-lime-50 border-y border-lime-100"
    >
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-center text-xs font-bold text-lime-600 uppercase tracking-widest mb-6">
    ...
    <section id="features" className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-xs font-bold text-lime-600 uppercase tracking-widest mb-3">
            Everything you need
          </p>
          <h2
  ...
  const steps = [
    {
      ...
      desc: "Set up your organisation in under 2 minutes. Upload your logo, name your workspace.",
    },
    {
      num: "02",
      title: "Add your admin account",
      desc: "Create the first admin user who can invite, assign roles, and configure teams.",
    },
    {
      num: "03",
    ...
    },
    {
      num: "04",
      title: "Go live",
      desc: "Start reporting incidents, tracking responders, and resolving issues in real time.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            <div
              key={i}
              className="relative p-7 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/8 hover:border-lime-500/30 transition-all group"
            >
              <p
                className="text-5xl font-black text-lime-400/20 group-hover:text-lime-400/40 transition-colors mb-4"
                style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
              >
                {s.num}
              </p>
    ...
    <div className="flex items-center gap-2 mb-10">
      {[1, 2].map((n) => (
        <div key={n} className="flex items-center gap-2 flex-1">
          ...
          <span
            className={`text-xs font-semibold ${step >= n ? "text-gray-800" : "text-gray-400"}`}
          >
            {n === 1 ? "Company" : "Your Account"}
          </span>
          {n < 2 && (
            <div
              className={`flex-1 h-0.5 rounded-full ${step > n ? "bg-lime-400" : "bg-gray-100"}`}
            />
          )}
        </div>
      ))}
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1 text-sm">
          This is your organisation's workspace in SafeZone.
        </p>
      </div>
            ...
            {preview ? (
              <div className="text-center">
                <img
                  src={preview}
                  alt="Logo preview"
                  className="w-20 h-20 object-contain mx-auto rounded-xl mb-3 shadow-md"
                />
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1 text-sm">
          You'll be the first admin. You can invite the rest of your team from
          inside the app.
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          {field("Team / Department", "team", {
            placeholder: "e.g. Dock Operations",
          })}
        </div>
  ...
  return (
    <div className="text-center py-6">
      ...
      <p className="text-gray-500 text-sm mb-1">
        <span className="font-bold text-gray-800">{companyName}</span> has been
        registered on SafeZone.
      </p>
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 pb-0">
          <div className="flex items-center gap-2">
            ...
            <span
              className="font-black text-lg tracking-tight text-gray-900"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
              Safe<span className="text-lime-500">Zone</span>
            </span>
      ...
      <footer className="bg-gray-950 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-500">
            © 2026 SafeZone. Real-time incident management for every industry.
          </p>
          <div className="flex gap-5">
            {["Privacy", "Terms", "Contact"].map((t) => (
              <a
                key={t}
                href="#"
                className="text-xs text-gray-500 hover:text-lime-400 transition-colors font-medium"
              >
                {t}
              </a>
            ))}
