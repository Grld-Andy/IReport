      ...
      {cardDetails.subtitle && (
        <div className="flex-col gap-2">
          ...
          >
            <span
              className={`
                grid place-items-center min-w-[70px] px-2 h-[20px] border-[1px]  rounded-full
              ...
              `}
            >
              {cardDetails.percentage > 0 ? "+" : ""}{cardDetails.percentage}%
            </span>
            <p className="text-nowrap">{cardDetails.subtitle}</p>
          </div>
        </div>
      )}
    </div>
