...
internal class VerifyPaymentQueryHandler(PaystackService _paystackService) : IQueryHandler<VerifyPaymentQuery, VerifyPaymentResponse>
{
    private readonly PaystackService paystackService = _paystackService;
    public async Task<VerifyPaymentResponse> HandleAsync(VerifyPaymentQuery query, CancellationToken cancellationToken = default)
    {
